...
while($rowOrder = mysql_fetch_array($sqlOrder)){
    ...
    if($rowOrder['payment_method_id'] == 5 || $rowOrder['payment_method_id'] == 6 || $rowOrder['payment_method_id'] == 7){ // ABA
        include('/var/www/CoContorlF/app/webroot/includes/PayWayApiCheckout.php');
        ...
        include('/var/www/CoContorlF/app/webroot/includes/AcledaCheckout.php');
        ...
        include("/var/www/CoContorlF/app/webroot/includes/NewWingConfig.php");
