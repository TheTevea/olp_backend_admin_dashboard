...
class ReportsController extends AppController {
    ...
    function salesTicket() {
        ...
        $companies    = ClassRegistry::init('Company')->find('list', array("conditions" => array("Company.is_active = 1".$comCondition)));
        $branches     = ClassRegistry::init('Branch')->find('all', array("conditions" => array("Branch.is_active = 1".$braCondition)));
