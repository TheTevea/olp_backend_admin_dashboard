...
<script type="text/javascript">
    ...
    function loadTAgent(){
        ...
        Tablesetting.sAjaxSource = "<?php echo $this->base . '/' . $this->params['controller']; ?>/ajax/"+$("#tAgentType").val()+"/"+$("#tAgentGroup").val();
        oCache.iCacheLower = -1;
        oTableTAgent.fnDraw(false);
    }
</script>
<div class="leftPanel">
    <div class="filter-header">
        ...
        <div class="add-new-section">
            <button type="button" class="add-new-btn btnAddTAgent">
        ...
        <div class="filter-section">
            ...
            <div class="filter-header-container">
                ...
                <div class="filter-group">
                    <select id="tAgentGroup">
                        <option value="all"><?php echo "All Agency Group"; ?></option>
                        <?php
                ...
                <div class="filter-group">
                    <select id="tAgentType">
                        <option value="all"><?php echo "All Type"; ?></option>
