...
<?php 
echo $this->Form->create('TRoute', array('class' => 'form-table-container')); 
    ...
    <fieldset>
        ...
        <table class="form-table">
            ...
            <tr class="form-row">
                ...
                <td class="form-input-cell">
                    <div class="form-input-container">
                        <?php echo $this->Form->textarea('description', array('class' => 'form-input', 'style' => 'height: 40px;', 'label' => false, 'div' => false)); ?>
                    </div>
                </td>
            </tr>
        </table>
