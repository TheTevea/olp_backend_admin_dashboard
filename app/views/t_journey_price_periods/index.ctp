...
//                                        }
        ...
        $(".btnAddTJourneyPricePeriod").unbind('click').click(function(event){
            event.preventDefault();
    ...
    <div class="filter-container">
        <div class="filter-row">
            <div class="filter-group">
                <button type="button" class="positive-btn btnAddTJourneyPricePeriod">
                    <i class="fas fa-plus"></i>
                    <span><?php echo MENU_SET_PRICE_PERIOD_ADD; ?></span>
                </button>
            </div>
        </div>
    </div>
