...
<?php echo $this->Form->create('TDestination', array('class' => 'form-table-container')); ?>
        ...
        <table class="form-table">
            ...
            <tr class="form-row" style="border-bottom: none;">
                ...
                <td class="form-input-cell" style="vertical-align: top;">
                    <select id="TDestinationAvbSelected" name="data[TDestination][t_destination_to_id][]" multiple="multiple" style="width: 280px; height: 200px;"></select>
                </td>
            </tr>
        </table>
    </fieldset>
