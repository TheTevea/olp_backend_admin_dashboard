...
<fieldset style="width: 48%; float: left; height: 600px;">
...
<!--            <tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <?php echo number_format($this->data['TJourney']['agetn_price_percent'], 2)." ".$this->data['CurrencyCenter']['symbol']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <?php 
                    $sqlDropOff = mysql_query("SELECT GROUP_CONCAT(name) FROM t_drop_offs WHERE id IN (SELECT t_drop_off_id FROM t_journey_drop_offs WHERE t_journey_id = ".$this->data['TJourney']['id'].")");
            ...
            <tr>
                ...
                <td>
                    <?php
                    $sqlBoardingPoint = mysql_query("SELECT GROUP_CONCAT(name) FROM t_boarding_points WHERE id IN (SELECT t_boarding_point_id FROM t_journey_boarding_points WHERE t_journey_id = ".$this->data['TJourney']['id'].")");
                    $rowBoardingPoint = mysql_fetch_array($sqlBoardingPoint);
                    echo $rowBoardingPoint[0];
                    ?>
                </td>
            </tr>
            <tr>
