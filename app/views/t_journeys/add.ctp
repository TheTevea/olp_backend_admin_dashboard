...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        if(COUNT($branches) == 1){
        ?>
        $("#TJourneyBranchId").change();
        <?php
        }
        ?>
        
        $("#TJourneyAgentPriceAmount, #TJourneyAgetnPricePercent").unbind('focus').focus(function(){
            if(replaceNum($(this).val()) == 0){
                $(this).val('');
            }
        });
        
        $("#TJourneyAgentPriceAmount, #TJourneyAgetnPricePercent").unbind('blur').blur(function(){
            if($(this).val() == ''){
                $(this).val('0');
            }
        });
...
<div class="form-container" id="tJourneyFormContainer">
    <fieldset style="width: 48%; float: left; min-height: 900px;">
        ...
        <table cellpadding="3" style="width: 99%;">
            <tr>
                ...
                <td>
                    <div class="inputContainer">
                        ...
                        echo $this->Form->input('company_id', array('class'=>'validate[required] journeySelectChz', 'label' => false, 'empty' => $comEmpty, 'div' => false, 'style' => 'width: 250px')); ?>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('foreigner_price', array('class'=>'validate[required] float', 'style' => 'width: 240px')); ?> <span class="TJourneySymbolCurrency"></span>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('agetn_price_percent', array('class'=>'validate[required] float', 'style' => 'width: 240px')); ?> <span class="TJourneySymbolCurrency"></span>
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <fieldset style="width: 48%; float: right; min-height: 900px;">
        ...
        <table cellpadding="3">
            ...
            <tr>
                ...
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('price_period_foreigner_price', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <span class="TJourneySymbolCurrency"></span>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('price_period_agency_price_foreigner', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off')); ?> <span class="TJourneySymbolCurrency"></span>
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <fieldset style="width: 48%; float: left; height: 400px; overflow-x: hidden; overflow-y: scroll;">
        ...
        <br/>
        <table cellpadding="5" cellspacing="0" style="width: 100%; display: none;" id="divRouteMultiJourney">
            <tr>
                                    ...
                                    <table cellpadding="5" cellspacing="0" style="width: 100%;">
                                        ...
                                        <tbody class="rowTransitListDetail">
                                            <tr id="rowListTransitDetail" class="rowListTransitDetail">
                                                ...
                                                <td style="text-align: center; border-bottom: 1px solid #000; display: none;">
