...
<div class="leftPanel">
    <div id="<?php echo $printArea; ?>">
        ...
        $excelContent .= "\nWalk In Revenue";
        $excelContent .= "\nNo\tTicket Code\tBooking Date\tTravel Date\tDeparture Time\tDirection\tType\tSeat No\tEdited\tDiscount\tAmount";
        $symbol = '';
        ...
        <div id="dynamic">
            <table class="table_print" cellspacing="0">
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td colspan="12" style="text-align: center; padding: 5px;"><?php echo TABLE_NO_MATCHING_RECORD; ?></td>
                    </tr>
                    <?php
                    }
                    ...
                    ?>
                    <tr>
                        <td style="text-align: right; padding: 5px;  font-size: 12px; font-weight: bold;" colspan="11">Total</td>
