...
<div class="print_doc" style="width: 300px;">
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    <tr>
                        <td style="vertical-align: top; text-align: center; width: 100px; font-size: 12px;">
                            <b style="font-size: 14px;">Olongpich Transportation</b>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table style="width: 100%;">
        <tr>
            <td style="width: 48%; font-size: 10px; text-align: right;">Invoice#:</td>
            <td style="font-size: 10px;">
                <?php echo $this->data['TTicket']['code']; ?>
            </td>
        </tr>
        <!-- <tr><td style="font-size: 10px; text-align: right;">Customer:</td>
        <td style="font-size: 10px;"><?php //echo $customerType; ?></td></tr> -->
        <tr><td style="font-size: 10px; text-align: right;">Telephone:</td>
        <td style="font-size: 10px;"><?php echo $this->data['TTicket']['telephone']; ?></td></tr>
        <tr><td style="font-size: 10px; text-align: right;">Issued Date:</td>
            <td style="font-size: 10px;">
                <?php 
        ...
        <tr><td style="font-size: 10px; text-align: right;">Travel Date:</td>
            <td style="font-size: 10px;">
                <?php 
        ...
        <tr><td style="font-size: 10px; text-align: right; vertical-align: text-top;">Direction:</td>
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr><td style="font-size: 10px; width: 35%; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000;">Seat#</td>
        <td style="font-size: 10px; width: 15%; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000;">Qty</td>
        <td style="font-size: 10px; width: 20%; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; text-align: right;">Price</td>
        <td style="font-size: 10px; width: 20%; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; text-align: right;">Amount</td></tr>
        <?php
        $qty  = 0;
        $item = "";
        $unitPrice   = 0;
        ...
        ?>
        <tr>
            <td style="font-size: 10px; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000;"><?php echo $item; ?></td>
        ...
        <tr>
            <td style="font-size: 10px; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; text-align: right;" colspan="2">Total</td>
        ...
        <tr>
            <td style="font-size: 10px; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; text-align: right;" colspan="2">Discount</td>
            ...
            <?php
            if($totalAmount > 0){
                echo number_format($this->data['TTicket']['discount_amount'] + $this->data['TTicket']['total_change'], 2); 
            } else {
                echo '0';
            }
            ?> $
        ...
        <tr>
            <td style="font-size: 10px; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; text-align: right;" colspan="2">Grand Total</td>
            <td style="font-size: 10px; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; text-align: right;" colspan="2">
            <?php 
            $grandTotalUs   = $totalAmount + $this->data['TTicket']['lucky_draw_fee'] - $this->data['TTicket']['discount_amount'] - $this->data['TTicket']['total_change'];
            if($grandTotalUs > 0){
    ...
    <table style="width: 100%;">
        <tr>
            ...
            echo $this->data['TBoardingPoint']['name'];  ?> (<?php echo $boardingPointTime; ?>) <?php echo $this->data['Branch']['telephone']; ?>
            </td>
        </tr>
        <tr>
            <td style="font-size: 10px;">
        ...
        <tr><td style="font-size: 10px;">Term & Condition:</td></tr>
    ...
    <!-- <div style="width: 100%;" class="breakPage">
        <table style="width: 100%;" cellpadding="0" cellspacing="3">
            <tr><td style="width: 60%; font-size: 10px;">Invoice No.:<br/><?php //echo $this->data['TTicket']['code']."_".$data['number']; ?></td>
            ...
            <tr><td style="font-size: 10px;">Direction:<br/><?php //echo $destinationFromName." -> ".$destinationToName; ?></td></tr>
            <tr><td style="font-size: 10px;">Seat No.: <?php //echo $data['number']; ?></td></tr>
            <tr><td style="font-size: 10px;">Customer: <?php //echo $customerType; ?></td></tr>
            <tr><td style="font-size: 10px;">Issued Date: <?php //echo dateShort($this->data['TTicket']['date']); ?></td></tr>
            <tr><td style="font-size: 10px;">Journey Date:<br/>
                <?php 
                // $depare  = explode(":", $this->data['TTicket']['journey_time']);
                // $depareureTime = (int) $depare[0];
                // if(strtotime($this->data['TTicket']['journey_date']) >= strtotime("2021-12-07")){
