...
<fieldset>
    ...
    <div style="width: 67%; float: right; display: none;">
        <div class="print_doc" style="width: 320px; float: left; border: 1px solid #000; padding-left: 5px; padding-right: 5px;">
            <div class="bgtext">
                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                <tr>
                                    <td style="vertical-align: top; text-align: center; width: 100px; font-size: 12px;">
                                        <b style="font-size: 14px;">Travel Bus Asia</b>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 48%; font-size: 10px; text-align: right;">Invoice No.:</td>
                    ...
                    <tr><td style="font-size: 10px; text-align: right;">Telephone No:</td>
                    ...
                    <tr><td style="font-size: 10px; text-align: right;">Journey Date:</td>
                        <td style="font-size: 10px;">
                            <?php 
                ...
                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                    <tr><td style="font-size: 10px; width: 35%; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000;">Seat No.</td>
                    <td style="font-size: 10px; width: 15%; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000;">Qty</td>
                    <td style="font-size: 10px; width: 20%; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; text-align: right;">Unit Price</td>
                    ...
                    <tr>
                        ...
                        <?php
                        if($totalAmount > 0){
                            echo number_format($rowTicket['discount_amount'], 2); 
                        } else {
                            echo '0';
                        }
                        ?> ฿
                    ...
                    <tr>
                        ...
                        <?php 
                        if($totalAmount > 0){
                            echo number_format($totalAmount - $rowTicket['discount_amount'] + $rowTicket['lucky_draw_fee'], 2);  
                        } else {
                            echo '0';
                        }
                        ?> ฿
                ...
                <table style="width: 100%;">
                    <tr><td style="font-size: 10px;">VAT INCLUDED</td></tr>
                    <tr><td style="font-size: 10px;">Exchange Rate: 4,100៛</td></tr>
            ...
            <div style="width: 47%; float: left; padding-left: 5px; padding-right: 5px; border: 1px solid #000; margin-bottom: 3px; margin-right: 3px;">
                <div class="bgtext">
                    <table style="width: 100%;" cellpadding="0" cellspacing="3">
                        <tr><td style="width: 60%; font-size: 10px;">Invoice No.:<br/><?php echo $rowTicket['code']."_".$data['number']; ?></td>
                        ...
                        <tr><td style="font-size: 10px;">Issued Date: <?php echo dateShort($rowTicket['date']); ?></td></tr>
