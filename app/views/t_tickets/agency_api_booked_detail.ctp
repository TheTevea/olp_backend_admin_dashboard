    ...
    <table class="table" cellspacing="0">
        <tbody>
            <tr>
                ...
                <th style="text-align: left;"><?php echo "Agency Name"; ?></th>
                <th style="width: 7%; text-align: left;"><?php echo "Ticket Code"; ?></th>
                <th style="width: 7%; text-align: left;"><?php echo "Transaction ID"; ?></th>
                <th style="width: 7%; text-align: left;"><?php echo "Reference"; ?></th>
                <th style="width: 7%; text-align: left;"><?php echo "Seat #"; ?></th>
                <th style="width: 10%; text-align: left;"><?php echo "From"; ?></th>
                <th style="width: 10%; text-align: left;"><?php echo "To"; ?></th>
                <th style="width: 10%; text-align: left;"><?php echo "Departure"; ?></th>
                <th style="width: 7%; text-align: left;"><?php echo "Telephone"; ?></th>
                <th style="width: 7%; text-align: left;"><?php echo "Email"; ?></th>
                <th style="width: 8%; text-align: right;"><?php echo GENERAL_AMOUNT; ?></th>
            </tr>
            <?php
            ...
            ?>
            <tr>
                <td colspan="12" style="text-align: center;"><?php echo TABLE_NO_RECORD; ?></td>
            </tr>
            <?php
                }
            }
