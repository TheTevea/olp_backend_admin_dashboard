        ...
        <table class="table" cellspacing="0">
            <tbody>
                <tr>
                    ...
                    <th style="text-align: left;"><?php echo MENU_AGENT; ?></th>
                    <th style="width: 20%; text-align: right;"><?php echo TABLE_TOTAL_BOOKED; ?></th>
                    <th style="width: 20%; text-align: right;"><?php echo GENERAL_AMOUNT; ?></th>
                </tr>
                <?php
