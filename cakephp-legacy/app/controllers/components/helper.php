...
//        $field['payment_method_id']      = 'others';
    ...
    function ticketSendEmail($transactionId){
        $result['status'] = 0;
        // QA
        $apiURL    = "https://qacltom.udaya-tech.com/olongPichWebApiQA";
        $apiKey    = "fa5ffe62-c84f-4119-9c5b-65bfabf74e53";
        // Production
        // $apiURL    = "https://apinlebiclosha.utebi.com/olPichWebApiPro";
        // $apiKey    = "5cd1be05-728f-4f7a-aafb-b244eb3d99b9";
        $headers[] = 'Accept: */*';
