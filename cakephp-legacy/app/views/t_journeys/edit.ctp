...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        getSymbolTJourney();
        $(".btnSaveTJourney").unbind("click").click(function(event){
            $("#TJourneyEditForm").submit();
        });
        ...
        $("#TJourneyAgentPriceAmount, #TJourneyAgetnPricePercent").focus(function(){
            if(replaceNum($(this).val()) == 0){
                $(this).val('');
            }
        });
        
        $("#TJourneyAgentPriceAmount, #TJourneyAgetnPricePercent").blur(function(){
            if($(this).val() == ''){
                $(this).val('0');
            }
        });
        ...
        $("#JourneyDirection").unbind('click').click(function(){
            ...
            $("#TJourneyUnitPrice, #TJourneyForeignerPrice, #TJourneyMembership").attr('readonly', false).val('');
            // Allow Outside
        ...
        $("#JourneyTransit").unbind('click').click(function(){
            ...
            cloneTransit();
            // Price Reanonly
            $("#TJourneyUnitPrice, #TJourneyForeignerPrice, #TJourneyMembership").attr('readonly', true).val('');
            // Allow Outside
        ...
        var datesPeriod = $("#TJourneyPricePeriodFrom, #TJourneyPricePeriodTo").datepicker({
            ...
            changeYear: true,
            onSelect: function( selectedDate ) {
                $("#TJourneyPricePeriodFrom, #TJourneyPricePeriodTo, #TJourneyPricePeriodPrice, #TJourneyPricePeriodForeignerPrice, #TJourneyPricePeriodMembership, #TJourneyPricePeriodAgencyPrice, #TJourneyPricePeriodAgencyPriceForeigner").addClass("validate[required]");
        ...
        $("#tJourneyClearPricePeriod").unbind("click").click(function(){
            ...
            $("#TJourneyPricePeriodPrice, #TJourneyPricePeriodForeignerPrice, #TJourneyPricePeriodMembership, #TJourneyPricePeriodAgencyPrice, #TJourneyPricePeriodAgencyPriceForeigner").val(0);
            $("#TJourneyPricePeriodFrom, #TJourneyPricePeriodTo, #TJourneyPricePeriodPrice, #TJourneyPricePeriodForeignerPrice, #TJourneyPricePeriodMembership, #TJourneyPricePeriodAgencyPrice, #TJourneyPricePeriodAgencyPriceForeigner").removeClass("validate[required]");
        });

        $("#TJourneyPricePeriodPrice, #TJourneyPricePeriodForeignerPrice, #TJourneyPricePeriodMembership, #TJourneyPricePeriodAgencyPrice, #TJourneyPricePeriodAgencyPriceForeigner").unbind("focus").focus(function(){
            if(replaceNum($(this).val()) == 0){
                $(this).val("");
            }
        });

        $("#TJourneyPricePeriodPrice, #TJourneyPricePeriodForeignerPrice, #TJourneyPricePeriodMembership, #TJourneyPricePeriodAgencyPrice, #TJourneyPricePeriodAgencyPriceForeigner").unbind("blur").blur(function(){
            if($(this).val() == ""){
                $(this).val(0);
            }
        });
        ...
        var datesPeriodInternal = $("#TJourneyPricePeriodFromInternal, #TJourneyPricePeriodToInternal").datepicker({
            ...
            changeYear: true,
            onSelect: function( selectedDate ) {
                $("#TJourneyPricePeriodFromInternal, #TJourneyPricePeriodToInternal, #TJourneyPricePeriodPriceInternal, #TJourneyPricePeriodForeignerPriceInternal, #TJourneyPricePeriodMembershipInternal, #TJourneyPricePeriodAgencyPriceInternal, #TJourneyPricePeriodAgencyPriceForeignerInternal").addClass("validate[required]");
        ...
        $("#tJourneyClearPricePeriodInternal").unbind("click").click(function(){
            ...
            $("#TJourneyPricePeriodPriceInternal, #TJourneyPricePeriodForeignerPriceInternal, #TJourneyPricePeriodMembershipInternal, #TJourneyPricePeriodAgencyPriceInternal, #TJourneyPricePeriodAgencyPriceForeignerInternal").val(0);
            $("#TJourneyPricePeriodFromInternal, #TJourneyPricePeriodToInternal, #TJourneyPricePeriodPriceInternal, #TJourneyPricePeriodForeignerPriceInternal, #TJourneyPricePeriodMembershipInternal, #TJourneyPricePeriodAgencyPriceInternal, #TJourneyPricePeriodAgencyPriceForeignerInternal").removeClass("validate[required]");
        });

        $("#TJourneyPricePeriodPriceInternal, #TJourneyPricePeriodForeignerPriceInternal, #TJourneyPricePeriodMembershipInternal, #TJourneyPricePeriodAgencyPriceInternal, #TJourneyPricePeriodAgencyPriceForeignerInternal").unbind("focus").focus(function(){
            if(replaceNum($(this).val()) == 0){
                $(this).val("");
            }
        });

        $("#TJourneyPricePeriodPriceInternal, #TJourneyPricePeriodForeignerPriceInternal, #TJourneyPricePeriodMembershipInternal, #TJourneyPricePeriodAgencyPriceInternal, #TJourneyPricePeriodAgencyPriceForeignerInternal").unbind("blur").blur(function(){
            if($(this).val() == ""){
                $(this).val(0);
            }
        });

        var dateProDis = $("#TJourneyPromotionDisStart, #TJourneyPromotionDisEnd").datepicker({
            dateFormat: 'dd/mm/yy',
            changeMonth: true,
            changeYear: true,
            onSelect: function( selectedDate ) {
                $("#TJourneyPromotionDisStart, #TJourneyPromotionDisEnd, #TJourneyPromotionDisPaymethod").addClass("validate[required]");
                if($(".TJourneyPromotionDisType:checked").val() == "1"){
                    $("#TJourneyPromotionDisPrice, #TJourneyPromotionDisPriceForeigner").addClass("validate[required]");
                } else {
                    $("#TJourneyPromotionDisPercentage").addClass("validate[required]");
                }
                var option = this.id == "TJourneyPromotionDisStart" ? "minDate" : "maxDate",
                    instance = $( this ).data( "datepicker" );
                    date = $.datepicker.parseDate(
                        instance.settings.dateFormat ||
                        $.datepicker._defaults.dateFormat,
                        selectedDate, instance.settings );
                dateProDis.not( this ).datepicker( "option", option, date );
            }
        });

        $("#TJourneyClearPromotionDis").unbind("click").click(function(){
            $("#TJourneyPromotionDisStart, #TJourneyPromotionDisEnd").val("");
            $("#TJourneyPromotionDisPercentage").val("");
            $("#TJourneyPromotionDisStart, #TJourneyPromotionDisEnd, #TJourneyPromotionDisPercentage, #TJourneyPromotionDisPaymethod, #TJourneyPromotionDisPrice, #TJourneyPromotionDisPriceForeigner").removeClass("validate[required]");
        });

        $(".TJourneyPromotionDisType").unbind("click").click(function(){
            $(".divPromotionDisPrice, .divPromotionDis").hide();
            $("#TJourneyPromotionDisPrice, #TJourneyPromotionDisPriceForeigner, #TJourneyPromotionDisPercentage").val("");
            $("#TJourneyPromotionDisPrice, #TJourneyPromotionDisPriceForeigner, #TJourneyPromotionDisPercentage").removeClass("validate[required]");
            if($(this).val() == "1"){
                $(".divPromotionDisPrice").show();
            } else {
                $(".divPromotionDis").show();
            }
            if($("#TJourneyPromotionDisStart").val() != "" || $("#TJourneyPromotionDisEnd").val() != ""){
                $("#TJourneyPromotionDisPrice, #TJourneyPromotionDisPriceForeigner, #TJourneyPromotionDisPercentage").addClass("validate[required]");
            }
        });
        ...
        var formHeight    = $('#tJourneyFormHeader').outerHeight(true);
        var formContainer = windowHeight - headerHeight - tabsNavHeight - formHeight - 100;
        $('#tJourneyFormContainer').css({
    ...
    function calculateTransitPrice(){
        ...
        $(".rowListTransit").each(function(){
            ...
            totalForeigner += replaceNum(journeySelect.find("option:selected").attr('foreigner'));
        });
        // Set Price
        $("#TJourneyUnitPrice").val(converDicemalJS(totalPrice).toFixed(2));
        $("#TJourneyMembership").val(converDicemalJS(totalVip).toFixed(2));
        $("#TJourneyForeignerPrice").val(converDicemalJS(totalForeigner).toFixed(2));
    }
</script>
<div class="filter-container" id="tJourneyFormHeader">
    <div class="filter-row">
        <div class="filter-form-group">
            <button type="button" class="form-btn btnBackTJourney">
                <i class="fas fa-chevron-left"></i>
                <span><?php echo ACTION_BACK; ?></span>
            </button>
        </div>
        <div class="filter-form-group">
            <button type="button" class="form-btn btnSaveTJourney">
...
<div class="form-container" id="tJourneyFormContainer">
    <fieldset style="width: 48%; float: left; min-height: 1050px;">
        ...
        <table cellpadding="3" style="width: 99%;">
            ...
            <tr>
                <td><label for="TJourneyUnitPrice"><?php echo "Selling Price ".TABLE_NORMAL; ?> <span class="red">*</span> :</label></td>
                <td>
                    <div class="inputContainer">
                        <?php 
                        $readonly = false;
            ...
            <tr>
                <td><label for="TJourneyForeignerPrice"><?php echo "Selling Price ".TABLE_FOREIGNER; ?> <span class="red">*</span> :</label></td>
                <td>
                    <div class="inputContainer">
                        <?php 
                        echo $this->Form->text('foreigner_price', array('readonly' => $readonly, 'class'=>'validate[required] float', 'style' => 'width: 240px', 'value' => number_format($this->data['TJourney']['foreigner_price'], 2))); ?> <span class="TJourneySymbolCurrency"></span>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label for="TJourneyAgetnPricePercent"><?php echo "Agency Price (Foreigner)"; ?> <span class="red">*</span> :</label></td>
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('agetn_price_percent', array('readonly' => $readonly, 'class'=>'validate[required] float', 'style' => 'width: 240px', 'value' => number_format($this->data['TJourney']['agetn_price_percent'], 2))); ?> <span class="TJourneySymbolCurrency"></span>
                    </div>
                </td>
            </tr>
            <tr>
                    ...
                    <table cellpadding="5" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody id="rowBoardingPointList">
                            <tr id="rowListBoardingPoint" class="rowListBoardingPoint">
                                <td class="first" style="border-bottom: 1px solid #000;">
    ...
    <fieldset style="width: 48%; float: right; min-height: 1050px;">
        ...
        <table cellpadding="3">
            ...
            if(mysql_num_rows($sqlPricePeriod)){
                ...
                $pricePeriodForieg   = number_format($rowPricePeriod['foreigner_price'], 2);
                ...
                $pricePeriodAgencyEn = number_format($rowPricePeriod['agency_price_foreigner'], 2);
            }
            ?>
            <tr>
                <td colspan="2">
                    <span style="font-size: 14px; font-weight: bold;">Price Promotion</span> <img alt="" src="<?php echo $this->webroot; ?>img/button/clear.png" style="cursor: pointer;" onmouseover="Tip('Clear Date')" id="tJourneyClearPricePeriod" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label for="TJourneyPricePeriodPrice"><?php echo "Selling Price ".TABLE_NORMAL; ?> :</label></td>
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('price_period_price', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off', 'value' => $pricePeriodPrice)); ?> $
                    </div>
                </td>
            </tr>
            <tr>
                <td><label for="TJourneyPricePeriodForeignerPrice"><?php echo "Selling Price ".TABLE_FOREIGNER; ?> :</label></td>
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('price_period_foreigner_price', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off', 'value' => $pricePeriodForieg)); ?> $
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('price_period_membership', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off', 'value' => $pricePeriodMember)); ?> $
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('price_period_agency_price', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off', 'value' => $pricePeriodAgencyKh)); ?> $
                    </div>
                </td>
            </tr>
            <tr>
                <td><label for="TJourneyPricePeriodMembership"><?php echo "Agency Price (Foreigner)"; ?> :</label></td>
                <td>
                    <div class="inputContainer">
                        <?php echo $this->Form->text('price_period_agency_price_foreigner', array('class'=>'float', 'style' => 'width: 200px; height: 20px;', 'autocomplete' => 'off', 'value' => $pricePeriodAgencyEn)); ?> $
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td style="vertical-align: top;">
                    <div class="inputContainer">
                        <?php 
                        echo $this->Form->textarea('note', array('style' => 'width: 240px; height: 80px;', 'autocomplete' => false)); ?>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <fieldset style="width: 48%; float: left; height: 400px; overflow-x: hidden; overflow-y: scroll;">
        ...
        <table cellpadding="0" cellspacing="0" style="width: 90%;">
            <tr>
                <td style="width: 35%;">Transport Route Display: </td>
                <td>
                    <?php 
                    $transportDisplay = "";
        ...
        <br/>
        <table cellpadding="5" cellspacing="0" style="width: 100%; <?php if($this->data['TJourney']['type'] != 3){ ?>display: none;<?php } ?>" id="divRouteMultiJourney">
            <tr>
