...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#TAgentType").unbind("change").change(function(){
            $(".tAgentCommissionAgency, #divTAgentCommission").show();
            $("#divTAgentCommissionFixAmount").hide();
            $(".tAgentCommissionType[value='1']").attr("checked", true);
            $("#TAgentCommission, #TAgentCommissionFixAmount").val('0');
//            $("#TAgentPayment").showHideDropdownOptions("", true);
//            $("#TAgentPayment").showHideDropdownOptions("1", true);
//            $("#TAgentPayment").showHideDropdownOptions("2", true);
//            $("#TAgentPayment").find("option[value='']").attr("selected", true);
            if($(this).val() == '3'){
                $(".tAgentCommissionAgency").hide();
                $("#divTAgentCommission").show();
                $("#TAgentCommission").val('10');
//                $("#TAgentPayment").find("option[value='1']").attr("selected", true);
//                $("#TAgentPayment").showHideDropdownOptions("", false);
//                $("#TAgentPayment").showHideDropdownOptions("1", true);
//                $("#TAgentPayment").showHideDropdownOptions("2", false);
            }
            showHideBonus();
        });
        ...
        $("#TAgentCommission, #TAgentCommissionFixAmount").unbind("focus").focus(function(){
            if(replaceNum($(this).val()) == 0){
                $(this).val("");
            }
        });

        $("#TAgentCommission, #TAgentCommissionFixAmount").unbind("blur").blur(function(){
            if($(this).val() == ""){
                $(this).val("0");
            }
        });
...
<fieldset style="width: 45%; float: left; height: 490px;">
    <legend><?php __(MENU_AGENT_INFO); ?></legend>
    <table>
        <tr>
            <td style="width: 120px;"><label for="TAgentType"><?php echo TABLE_TYPE; ?> <span class="red">*</span> :</label></td>
            <td>
        ...
        <tr>
            <td><label for="TAgentCommision"><?php echo MENU_COMMISION; ?> <span class="red">*</span> :</label></td>
            <td>
                <div class="inputContainer">
