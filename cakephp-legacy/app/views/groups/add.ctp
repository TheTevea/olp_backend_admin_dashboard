    ...
    $(document).ready(function(){
        ...
        $("#GroupAddForm").ajaxForm({
            ...
            beforeSubmit: function(arr, $form, options) {
                $(".txtSaveGroup").html("<?php echo ACTION_LOADING; ?>");
...
<?php echo $this->Form->create('Group', array('class' => 'form-table-container')); ?>
        ...
        <table class="form-table">
            ...
            <tr class="form-row" style="border-bottom: none;">
                <td class="form-input-cell" style="vertical-align: top; width: 300px;">
                    <select id="s" multiple="multiple" style="width: 280px; height: 200px;">
                        <?php
                        if($user['User']['type'] != 1){
                ...
                <td class="form-input-cell" style="vertical-align: top;">
                    <select id="d" name="data[Group][user_id][]" multiple="multiple" style="width: 280px; height: 200px;"></select>
                </td>
            </tr>
        </table>
    </fieldset>
