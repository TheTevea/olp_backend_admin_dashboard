...
$excelContent .= "\n\n".TABLE_NO."\tTransaction ID\t".TABLE_TICKET_CODE."\t".TABLE_BOOKING_DATE."\t".TABLE_JOURNEY_DATE."\t".REPORT_FROM."\t".REPORT_TO."\t".TABLE_SEAT."\t".TABLE_FARE."\t".TABLE_TELEPHONE."\tPayment Type\t".TABLE_TYPE."\t".TABLE_CREATED;
...
/* Customize condition */
$condition = "t_tickets.terminal_id IS NULL AND (t_tickets.type = 5 OR t_tickets.type = 11)";
