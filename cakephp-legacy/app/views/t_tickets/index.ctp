...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#dialog, #dialog1").html("");
        // Chosen
        $("#ticketBookingDestinationFrom, #ticketBookingDestinationTo").chosen({width: 300});
        $("#ticketBookingDestinationFrom_chosen, #ticketBookingDestinationTo_chosen").removeAttr("style");
        <?php
        if($user['User']['type'] == 2){
        ?>
        ...
        // Swap destinations functionality
        $('#swapDestinations').click(function() {
            var fromValue = $('#ticketBookingDestinationFrom').val();
            var fromText = $('#ticketBookingDestinationFrom option:selected').text();
            var toValue = $('#ticketBookingDestinationTo').val();
            var toText = $('#ticketBookingDestinationTo option:selected').text();
            
            // Swap values
            $('#ticketBookingDestinationFrom').val(toValue);
            $('#ticketBookingDestinationTo').val(fromValue);
            
            // Update displayed text (in case the selects are not refreshed automatically)
            if (toValue === '') {
                $('#ticketBookingDestinationFrom').find('option:first').prop('selected', true);
            }
            if (fromValue === '') {
                $('#ticketBookingDestinationTo').find('option:first').prop('selected', true);
            }
            $("#ticketBookingDestinationFrom").trigger("chosen:updated");
            $("#ticketBookingDestinationTo").trigger("chosen:updated");
        });
    });
    ...
    function generalInvoiceVatPrint(breakPage, invoiceCode, customerType, telephone, issuedDate, journeyDate, direction, boardingPoint, boardingPointTel, dropOff, dropOffTel, seatLabel, seatQty, unitPrice, totalAmt, totalDis, totalVat, total, totalRiel, totalExtraPrice){
        ...
        layout += '<tr><td style="vertical-align: top; text-align: center; width: 100px; font-size: 12px;"><b style="font-size: 14px;">Olongpich Transportation</b></td></tr>';
        layout += '</table></td><td style="width: 10%; font-size: 26px; font-weight: bold;"></td></tr>';
        layout += '</table>';
        layout += '<table style="width: 100%;">';
        layout += '<tr><td style="width: 48%; font-size: 10px; text-align: right;">Invoice#:</td>';
        layout += '<td style="font-size: 10px;">'+invoiceCode+'</td></tr>';
        // layout += '<tr><td style="font-size: 10px; text-align: right;">Customer:</td>';
        // layout += '<td style="font-size: 10px;">'+customerType+'</td></tr>';
        layout += '<tr><td style="font-size: 10px; text-align: right;">Telephone:</td>';
        layout += '<td style="font-size: 10px;">'+telephone+'</td></tr>';
        layout += '<tr><td style="font-size: 10px; text-align: right;">Issued Date:</td>';
        layout += '<td style="font-size: 10px;">'+issuedDate+'</td></tr>';
        layout += '<tr><td style="font-size: 10px; text-align: right;">Travel Date:</td>';
        layout += '<td style="font-size: 10px;">'+journeyDate+'</td></tr>';
        layout += '<tr><td style="font-size: 10px; text-align: right; vertical-align: text-top;">Direction:</td>';
        ...
        layout += '<tr><td style="font-size: 10px; width: 35%; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000;">Seat#</td>';
        layout += '<td style="font-size: 10px; width: 15%; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000;">Qty</td>';
        layout += '<td style="font-size: 10px; width: 20%; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; text-align: right;">Price</td>';
        layout += '<td style="font-size: 10px; width: 20%; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; text-align: right;">Amount</td></tr>';
        ...
        layout += '<tr><td style="font-size: 10px; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; text-align: right;" colspan="2">Total</td>';
        ...
        layout += '<tr><td style="font-size: 10px; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; text-align: right;" colspan="2">Discount</td>';
        ...
        layout += '<tr><td style="font-size: 10px; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; text-align: right;" colspan="2">Grand Total</td>';
        layout += '<td style="font-size: 10px; padding: 2px; margin: 0px; border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; text-align: right;" colspan="2">'+total+'</td></tr></table>';
        layout += '<table style="width: 100%;">';
        layout += '<tr><td style="font-size: 10px;">- Boarding Point: <br/>'+boardingPoint+' '+boardingPointTel+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">- Drop Off Point: <br/>'+dropOff+' '+dropOffTel+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">Term & Condition: </td></tr>';
    ...
    function generalLayoutPrintSeatVat(invoiceCode, qrCode, direction, seatNo, customerType, issuedDate, journeyDate){
        ...
        layout += '<tr><td style="width: 60%; font-size: 10px;">Invoice#:<br/>'+invoiceCode+'</td>';
        layout += '<td rowspan="6"><input type="hidden" class="qrCodeTicket" value="'+qrCode+'" /><div class="cardQRCode"></div></td></tr>';
        layout += '<tr><td style="font-size: 10px;">Direction:<br/>'+direction+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">Seat#: '+seatNo+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">Customer: '+customerType+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">Issued Date: '+issuedDate+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">Travel Date:<br/>'+journeyDate+'</td></tr></table>';
        layout += '</div>';
        return layout;
    }
    ...
    function generalLayoutPrintLuckyTicket(invoiceCode, telephone, direction, seatNo, customerType, issuedDate, journeyDate){
        ...
        layout += '<tr><td style="font-size: 10px;">Telephone No.: '+telephone+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">Invoice No.: '+invoiceCode+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">Direction: '+direction+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">Seat No.: '+seatNo+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">Customer: '+customerType+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">Issued Date: '+issuedDate+'</td></tr>';
        layout += '<tr><td style="font-size: 10px;">Journey Date: '+journeyDate+'</td></tr></table>';
        layout += '</div>';
        return layout;
    }
    ...
    function generalLayoutPrintTicket(brackPage, companyName, companyType, website, ticketSymbol, ticketNo, branchName, customerType, cusTel, refCode, travelDate){
        ...
        layout += '<tr><td style="font-size: 10px;">Ticket No. : <b>'+ticketNo+'</b></td></tr>';
        // layout += '<tr><td style="font-size: 10px;">Type Of Customer : '+customerType+'</td><div style="width: 80px; float: right; text-align: right;">'+cusTel+'</div><div style="clear: both;"></div></tr>';
        if(refCode != ''){
            layout += '<tr><td style="font-size: 10px;">Reference : '+refCode+'</td></tr>';
        }
        layout += '<tr><td style="font-size: 10px;">Travel Date : '+travelDate+'</td></tr></table>';
        return layout;
    }
    ...
    function generateLayoutPrintSeat(seatNo, transportaionType, direction, dropOff, boarding, price, noPaidLabel){
        ...
        layout += '<tr><td style="border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; vertical-align: top; font-size: 10px;" colspan="2">Seat#: '+seatNo+'<div style="width: 100px; float: right; text-align: right;">'+transportaionType+'</div></td></tr>';
        layout += '<tr><td style="width: 45%; border-top: 1px solid #000; border-left: 1px solid #000; font-size: 10px;">Direction</td>';
        ...
        layout += '<tr><td style="border-top: 1px solid #000; border-left: 1px solid #000; font-size: 10px;">Boarding Point</td>';
        ...
        layout += '<tr><td style="border-top: 1px solid #000; border-left: 1px solid #000; font-size: 10px;">Drop Off Point</td>';
        ...
        layout += '<tr><td style="border-top: 1px solid #000; border-left: 1px solid #000; border-bottom: 1px solid #000; font-size: 10px;">Amount <span style=" font-size: 10px; font-weight: bold;">'+noPaidLabel+'</span></td>';
    ...
    function generateLayoutPrintSeatOpen(totalSeat, direction, dropOff, boarding, price){
        ...
        // Seat
        layout += '<table style="width: 100%; margin-top: 5px;" cellspacing="0">';
        layout += '<tr><td style="border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; vertical-align: top; font-size: 10px;" colspan="2">Total Seat : '+totalSeat+'</td></tr>';
        layout += '<tr><td style="width: 45%; border-top: 1px solid #000; border-left: 1px solid #000; font-size: 10px;">Direction</td>';
        layout += '<td style="border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding-left: 5px; font-size: 10px;">'+direction+'</td></tr>';
        layout += '<tr><td style="border-top: 1px solid #000; border-left: 1px solid #000; font-size: 10px;">Drop Off Point</td>';
        layout += '<td style="border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding-left: 5px; font-size: 10px;">'+dropOff+'</td></tr>';
        layout += '<tr><td style="border-top: 1px solid #000; border-left: 1px solid #000; font-size: 10px;">Boarding Point</td>';
        layout += '<td style="border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding-left: 5px; font-size: 10px;">'+boarding+'</td></tr>';
        layout += '<tr><td style="border-top: 1px solid #000; border-left: 1px solid #000; border-bottom: 1px solid #000; font-size: 10px;">Amount</td>';
        layout += '<td style="border-top: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; padding-left: 5px; font-size: 10px;">'+price+'</td></tr></table>';
        return layout;
    }
    ...
    function generateLayoutPrintFooter(branchFName, branchFTel, branchTName, branchTTel, printDate, createdBy){
        ...
        // Footer
        layout += '<table style="width: 100%; margin-top: 5px;" cellspacing="0">';
        layout += '<tr><td colspan="2" style="font-size: 8px; text-decoration: underline;">Term & Condition</td></tr>';
        ...
        layout += '<tr><td style="font-size: 7px; padding-top: 5px;">Thank you for using our servive.<br/>'+branchFName+'<br/>H/P:'+branchFTel+'<br/>'+branchTName+'<br/>H/P:'+branchTTel+'</td>';
...
<!-- <div style="width: 100%; background-color: rgb(255 207 207 / var(--tw-bg-opacity, 1)); padding-top: 10px; padding-bottom: 10px; border-radius: 0.5rem; border: #e5e7eb;"> -->
    ...
    <div class="filter-container">
        <div class="filter-row">
            ...
            <div class="filter-group">
                <select id="ticketBookingDestinationFrom" class="filter-select">
                    <?php if(COUNT($tDestinationFroms) != 1): ?>
                        <option value=""><?php echo "Departure From"; ?></option>
                    <?php endif; ?>
                    <?php foreach($tDestinationFroms AS $tDestination): ?>
                        <?php $selected = ($tDestination['TDestination']['id'] == $defaultSelect) ? 'selected="selected"' : ''; ?>
                        <option value="<?php echo $tDestination['TDestination']['id']; ?>" <?php echo $selected; ?>>
                            <?php echo $tDestination['TDestination']['name']; ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <!-- Swap button -->
            <div class="filter-group swap-button">
                <button id="swapDestinations" style="background: none; border: none; cursor: pointer; height: 40px; width: 40px; display: flex; align-items: center; justify-content: center;">
                    <i class="fas fa-retweet" style="font-size: 16px; color: #555;"></i>
                </button>
            </div>

            <!-- Destination To -->
            <div class="filter-group">
                <select id="ticketBookingDestinationTo" class="filter-select">
                    <option value=""><?php echo "Going To"; ?></option>
                    <?php foreach($tDestinationFroms AS $tDestination): ?>
                        <option value="<?php echo $tDestination['TDestination']['id']; ?>">
                            <?php echo $tDestination['TDestination']['name']; ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="filter-group">
                <div class="date-input-group">
                    <input type="text" readonly id="ticketBookingDate" class="filter-date" value="<?php echo $dateSelect; ?>" />
                </div>
            </div>

            <!-- Action Buttons -->
            <div class="filter-group">
                <button class="positive-btn" id="ticketBookingSearch" style="min-width: 120px;">
                    <i class="fa fa-search"></i>
                    <span><?php echo GENERAL_SEARCH; ?></span>
                </button>
                <button class="positive-btn" id="btnFindTicketBooked" style="min-width: 120px;">
                    <i class="fa fa-phone"></i>
                    <span><?php echo ACTION_FIND_TICKET_PHONE; ?></span>
                </button>
            </div>
        </div>
    </div>
...
<div style="width: auto; margin-top: 10px;">
    <div style="width: 100%; margin: 0px auto; overflow: auto;" id="journeyScheduleList"></div>
</div>