...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#TDestinationFilterProvince_chosen").removeAttr("style");
...
<div class="leftPanel">
    <div class="filter-header">
        ...
        <div class="add-new-section">
            <button type="button" class="add-new-btn btnAddTDestination">
        ...
        <div class="filter-section">
            ...
            <div class="filter-header-container">
                ...
                <div class="filter-group">
                    <select id="TDestinationFilterProvince" class="filter-select">
                        <option value="all"><?php echo "All Province"; ?></option>
                        <?php
